...
set(VTKm_VERSION_FULL "2.2.0")
set(VTKm_VERSION "2.2")
...
if(CMAKE_CURRENT_LIST_DIR STREQUAL "D:/M/B/src/build-UCRT64/lib/cmake/vtk/vtkm")
  set(VTKm_PACKAGE_IN_BUILD TRUE)
endif()

if(VTKm_PACKAGE_IN_BUILD)
  set_and_check(VTKm_CMAKE_MODULE_PATH "D:/M/B/src/VTK-9.4.2/ThirdParty/vtkm/vtkvtkm/vtk-m/CMake")
else()
  set_and_check(VTKm_CMAKE_MODULE_PATH "${PACKAGE_PREFIX_DIR}/lib/cmake/vtk/vtkm/cmake")
endif()
...
set_and_check(VTKm_CONFIG_DIR "${PACKAGE_PREFIX_DIR}/lib/cmake/vtk/vtkm")
set(VTKM_FROM_INSTALL_DIR FALSE)
if(NOT "${CMAKE_BINARY_DIR}" STREQUAL "D:/M/B/src/build-UCRT64/ThirdParty/vtkm/vtkvtkm/vtk-m")
